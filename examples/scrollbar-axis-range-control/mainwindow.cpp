...
#include "ui_mainwindow.h"
 ...
 static const int my_size = 50000;
  ...
  ui(new Ui::MainWindow)
{
  ...
  ui->horizontalScrollBar->setRange(-my_size, my_size);
  ui->verticalScrollBar->setRange(-my_size, my_size);
...
void MainWindow::setupPlot()
{
  ...
  QVector<double> x(my_size ), y0(my_size ), y1(my_size );
  for (int i=0; i<my_size ; ++i)
  {
    x[i] = (i/(my_size-1.0)-0.5)*10;
